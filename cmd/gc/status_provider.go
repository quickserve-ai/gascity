...
var (
	...
	// partial output. Raised to 500ms by 0c61ea37e and then to 2s by
	// c2adf8cd8 (the later commit, and the value the deployed binary runs);
	// 2s lets a healthy probe finish while still bounding a wedged one.
