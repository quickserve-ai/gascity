...
func doStartStandalone(args []string, controllerMode bool, stdout, stderr io.Writer) int {
	...
	poolWorkBeads := filterAssignedWorkBeadsForPoolDemand(cfg, cityPath, openInfos, dsResult.AssignedWorkBeads, dsResult.AssignedWorkStoreRefs, dsResult.PoolWakeReadiness)
