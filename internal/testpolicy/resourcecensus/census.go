...
var bootstrapPolicy = Ledger{
	...
	Medium: []MediumOwner{
		...
		},
		{
			...
			Owner:           "TestKillTmuxServersUnderReapsSpawnedServer",
			Resources:       []Resource{ResourceTmux},
			OwnerBead:       "ga-cp3hwi",
			Invariant:       "the KillTmuxServersUnder reaping proof is a checked Medium tmux owner",
			ResourceOwner:   "the probe server is spawned on this test's private /tmp socket root and killed by PID in its own cleanup",
			MigrationTarget: "P0.4c-tmux",
			Expires:         "2026-10-01",
		},
		{
