...
| --- | --- | --- | --- | --- | --- | --- |
| Audit baseline | all tracked test source | fixed_sleep: 493 calls / 175 files (historical regex census: 447 / 157) | ga-cp3hwi | tracked test source totals remain visible as audit evidence; ga-cp3hwi owns this point-in-time source census | P0.4a | 2026-10-01 |
...
| Audit baseline | all tracked test source | subprocess: 694 calls / 201 files (historical regex census: 495 / 135) | ga-cp3hwi | tracked test source totals remain visible as audit evidence; ga-cp3hwi owns this point-in-time source census | P0.4a | 2026-10-01 |
...
| Medium owner | `test/tmuxtest` package `tmuxtest` | TestKillTmuxServersUnderReapsSpawnedServer: tmux | ga-cp3hwi | the KillTmuxServersUnder reaping proof is a checked Medium tmux owner; the probe server is spawned on this test's private /tmp socket root and killed by PID in its own cleanup | P0.4c-tmux | 2026-10-01 |
| Medium owner | `test/tmuxtest` package `tmuxtest` | TestSweepOrphanPIDPrefixedDirsReapsServerBeforeRemovingParent: tmux | ga-cp3hwi | the orphan-sweep reaping proof is a checked Medium tmux owner; the probe server is spawned on this test's private /tmp socket root and killed by PID in its own cleanup, because the test deletes the socket dir | P0.4c-tmux | 2026-10-01 |
...
| Small debt ratchet | all untagged test source | fixed_sleep: 330 calls / 123 files (historical regex census: 287 / 113) | ga-cp3hwi | untagged Small fixed-sleep call/file totals cannot grow; reductions must lower this baseline; non-Medium lexical owners replace elapsed wall time with lifecycle signals | W1-W5 | 2026-10-01 |
...
| Small debt ratchet | all untagged test source | subprocess: 464 calls / 130 files (historical regex census: 394 / 105) | ga-cp3hwi | untagged Small subprocess call/file totals cannot grow; reductions must lower this baseline; non-Medium lexical owners remove or replace each process call site | D1/D2/D5/D6/E6 | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | fixed_sleep: 330 calls / 123 files (historical regex census: 295 / 114) | ga-cp3hwi | untagged fixed-sleep call/file totals cannot grow; reductions must lower this baseline; each owning test replaces elapsed wall time with its lifecycle signal | W1-W5 | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | subprocess: 473 calls / 136 files (historical regex census: 380 / 98) | ga-cp3hwi | untagged subprocess call/file totals cannot grow; reductions must lower this baseline; each process-owning test removes or replaces its source call site | D1/D2/D5/D6/E6 | 2026-10-01 |
